...
@protocol WCFinderSearchPureTextCollectionViewCellDelegate;

@interface WCFinderSearchPureTextCollectionViewCell : UICollectionViewCell <WCFinderHeadImageViewDelegate, WCFinderSearchHighLightItemExt>
{
    id <WCFinderSearchPureTextCollectionViewCellDelegate> _delegate;
...
@property(nonatomic) __weak id <WCFinderSearchPureTextCollectionViewCellDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
