...
@interface WXGMigrationClientMgr : MMService <ChatMigrationGetConnectInfoDelegate, WXGMigrationClientLogicDelegate, WXGMigrationClientEntryViewControllerDelegate, WXGMigrationImportMessageHelperDelegate, WCImageFullScreeViewMgrExt, WCAccountAutoLoginControlLogicExt, MMServiceProtocol>
{
    _Bool m_isWorking;
