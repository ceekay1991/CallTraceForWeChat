...
@interface WNAudioMgr : MMService <MMServiceProtocol, IRecordPermissionCheckExt, IFavAudioRecorderExt, IFavAudioPlayerExt, IVOIPUILogicMgrExt, ISysCallCheckExt>
{
    int _recordStatus;
