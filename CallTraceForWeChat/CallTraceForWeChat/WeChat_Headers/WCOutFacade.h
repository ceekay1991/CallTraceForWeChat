...
@interface WCOutFacade : MMService <IFriendListMgrExt, IWCOutCallExt, IMsgExt, IMMWebViewControllerDeepLinkExt, IVOIPUILogicMgrExt, WCOutAddressBookLogicDelegate, MonoServiceMsgLogicDelegate, MMTipsViewControllerDelegate, IVOIPExt, IRecordPermissionCheckExt, MMServiceProtocol>
{
