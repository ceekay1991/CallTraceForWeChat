...
@class EmoticonCellLikeButton, EmotionCollectionFooterView, LoopPageScrollView, MMEmotionStoreNewSearchController, MMTimer, NSMutableArray, NSString, UICollectionView, UICollectionViewFlowLayout, UIImageView, UIView, UIViewController;
