...
@interface AudioReceiver : MMService <AMRAudioPlayerDelegate, SPXAudioPlayerDelegate, SilkAudioPlayerDelegate, DownloadVoiceDelegate, INewSyncExt, MMServiceProtocol>
{
