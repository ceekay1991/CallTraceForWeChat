...
@class MMImageScrollViewHelper, MMLoadingView, MMProgressViewEx, MMUIButton, NSArray, NSString, ScanQRCodeLogicController, UIImage, UIImageView, UIView, WCActionSheetWithScanWXCode, WCImageTranslateLogic, WCMediaItem, WCMediaItemWrap, WXFullScreenGestureRecognizer;
@protocol WCImageFullScreenViewContainerDelegate;

@interface WCImageFullScreenViewContainer : MMUIScrollView <WCActionSheetDelegate, BaseScanLogicDelegate, FullScreenGestureDelegate, WCImageTranslateDelegate, UIScrollViewDelegate, MMImageScrollViewHelperDelegate, WCFacadeExt>
{
