...
@interface WADownloadFileMgr : MMService <WAAppTaskMgrExt, MMServiceProtocol>
{
...
- (void)downloadFileWithAppID:(id)arg1 appVersion:(unsigned long long)arg2 isIgnoreCheckDomain:(_Bool)arg3 taskID:(id)arg4 url:(id)arg5 httpHeaders:(id)arg6 context:(id)arg7 completionHandler:(CDUnknownBlockType)arg8 headerHandler:(CDUnknownBlockType)arg9 progressHandler:(CDUnknownBlockType)arg10;
