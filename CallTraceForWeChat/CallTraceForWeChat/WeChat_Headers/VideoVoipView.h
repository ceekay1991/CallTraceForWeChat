...
@class AVAudioPlayer, AVCaptureVideoPreviewLayer, CContact, CMessageWrap, MMTimer, MultiTalkHDHeadView, NSString, UIButton, UIImageView, UILabel, UIView, VideoVoipTalkingView, VoipMinimizeReportObject, WCUIAlertView, WavAudioPlayer;
