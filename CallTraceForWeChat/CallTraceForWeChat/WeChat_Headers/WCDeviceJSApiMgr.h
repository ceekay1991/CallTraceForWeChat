...
@interface WCDeviceJSApiMgr : MMService <IWCLanDeviceMgrExt, MMServiceProtocol, WCDeviceJSApiBatchSearchLogicHelpDelegate, IWCDeviceAccountMgrExt, IWCDeviceBrandMgrExt>
{
    _Bool m_hasInit;
    _Bool m_hasInitLan;
