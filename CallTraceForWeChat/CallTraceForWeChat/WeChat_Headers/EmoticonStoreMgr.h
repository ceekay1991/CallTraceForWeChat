...
@class EmoticonStoreExptSetting, EmoticonStoreSession, NSData, NSMutableDictionary, NSMutableSet, NSOperationQueue, NSString;
...
@interface EmoticonStoreMgr : MMService <StoreEmotionExchangeEmotionPackCgiDelegate, MMServiceProtocol, PBMessageObserverDelegate, IAPExt, ICdnComMgrExt, IMMLanguageMgrExt>
{
    ...
    EmoticonStoreExptSetting *_emoticonStoreExptSetting;
}

+ (unsigned int)getIdKeyDownloadFailed;
+ (unsigned int)getIdKeyIdEmoticon;
@property(retain, nonatomic) EmoticonStoreExptSetting *emoticonStoreExptSetting; // @synthesize emoticonStoreExptSetting=_emoticonStoreExptSetting;
