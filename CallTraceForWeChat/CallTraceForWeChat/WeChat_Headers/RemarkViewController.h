...
@interface RemarkViewController : MMUIViewController <IContactTagViewControllerExt, ContactRemarkImgExt, UITextViewDelegate, UITextFieldDelegate, WCActionSheetDelegate, MMImagePickerManagerDelegate, CommonImageBrowserDelegate, MMTableViewInfoDelegate>
{
