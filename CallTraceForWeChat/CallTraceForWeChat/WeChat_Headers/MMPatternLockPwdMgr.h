...
@interface MMPatternLockPwdMgr : MMService <WCPayWalletUpdateExt, PBMessageObserverDelegate, CSettingExt, MMUIViewControllerDelegate, IWCPayControlLogicExt, MMServiceProtocol>
{
