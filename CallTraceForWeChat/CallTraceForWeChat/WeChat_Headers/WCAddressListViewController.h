...
@interface WCAddressListViewController : WCAddressBaseViewController <PasswordLogicDelegate, LongPressMenuViewDelegate, LongPressViewDelegate>
{
...
- (void)makeImportYiXunCell:(id)arg1 cellInfo:(struct WCTableViewNormalCellManager *)arg2;
