...
@interface WXGBackupMgr : MMService <IMsgExt, MMKernelExt, ChatMigrationGetConnectInfoDelegate, WXGBackupLogicDelegate, WXGBackupEntryViewControllerDelegate, WXGBackupImportMessageHelperDelegate, WXGChatLogDeleteHelperDelegate, WCImageFullScreeViewMgrExt, MMServiceProtocol>
{
