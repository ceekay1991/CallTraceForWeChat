...
@interface WCStoryFacade : MMService <WCStoryUploadCdnMgrDelegate, WCStoryCommentUploadMgrDelegate, IClearDataMgrExt, IContactMgrExt, WCFacadeExt, IExptServiceExt, MMServiceProtocol, WCPlayerDownloadMgrInterface>
{
