...
- (id)initWithMentionType:(unsigned long long)arg1 scene:(unsigned long long)arg2 finderUsername:(id)arg3 lastBuffer:(id)arg4 successful:(CDUnknownBlockType)arg5 failure:(CDUnknownBlockType)arg6;
