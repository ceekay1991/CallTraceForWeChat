...
@interface VOIPCSMgr : MMService <IAUAudioDeviceExt, INetworkStatusMgrExt, CNetworkStatusExt, PBMessageObserverDelegate, MMServiceProtocol, AVVideoDeviceSessionDelegate, AVVideoDataSource, AUAudioDataSource, ISysCallCheckExt>
{
