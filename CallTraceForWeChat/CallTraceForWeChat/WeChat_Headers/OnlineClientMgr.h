...
@interface OnlineClientMgr : MMService <IMMLanguageMgrExt, PBMessageObserverDelegate, IMMNewSessionMgrExt, MMKernelExt, IMMFontMgrExt, INewSyncExt, MMServiceProtocol>
{
