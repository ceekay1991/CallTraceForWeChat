...
@interface WAMsgNodeJSCoreCenter : MMService <IWAMsgNodeJSCoreDelegate, WAContactMgrExtension, WAMsgNodeLaunchLogicDelegate, IWAMsgNodeResourceMgrExt, MMServiceProtocol>
{
