...
@interface SetTrustedFriendsViewController : MMUIViewController <ChatRoomMemberGridViewDelegate, TrustedFriendsLogicDelegate, SetTrustedFriendTipsViewDelegate, ILinkEventExt, MMToastViewControllerDelegate>
{
    _Bool _m_isDeleting;
