...
@interface WXTalkMgr : MMService <AUAudioDataSource, IRemoteControlCheckExt, AVAudioPlayerDelegate, CNetworkStatusExt, IAUAudioDeviceExt, MMServiceProtocol, PBMessageObserverDelegate, IWXTalkPresentExt, IContactMgrExt, IMMNewSessionMgrComparerExt, MMKernelExt>
{
    _Bool _isInTalkRoom;
