...
@interface WSRecommendMgr : MMService <WSLocalWebViewControllerDelegate, IFunctionMsgExt, MMKernelExt, PBMessageObserverDelegate, MMServiceProtocol, IMinimizeTaskDelegateInterface>
{
