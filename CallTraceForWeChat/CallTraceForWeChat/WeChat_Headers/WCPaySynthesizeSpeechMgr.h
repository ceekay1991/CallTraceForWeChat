...
@interface WCPaySynthesizeSpeechMgr : MMService <WCPayLogicMgrExt, WCPaySynthesizeSpeechCgiDelegate, IMsgExt, IMMAudioPlayerQueueExt, MMKernelExt, MMServiceProtocol, VoIPPushKitExt>
{
    float _m_lastVolume;
