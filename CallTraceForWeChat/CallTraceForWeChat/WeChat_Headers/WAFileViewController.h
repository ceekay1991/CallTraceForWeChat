...
@class ForwardMessageLogicController, NSString, UITapGestureRecognizer, WKWebView;

@interface WAFileViewController : MMUIViewController <UIScrollViewDelegate, WKNavigationDelegate, UIGestureRecognizerDelegate, WCActionSheetDelegate, ForwardMessageLogicDelegate>
{
