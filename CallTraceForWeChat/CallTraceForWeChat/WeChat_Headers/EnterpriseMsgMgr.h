...
@interface EnterpriseMsgMgr : MMService <MMServiceProtocol, IMsgExt, IAudioToMessageExt, MessageWrapImgDelegate, OpenUploadMgrDelegate, OpenUploadCDNMgrDelegate, UploadImageCDNMgrDelegate, OpenDownloadCDNMgrDelegate, EnterpriseVoiceMsgMgrDelegate, EnterpriseSendMsgMgrDelegate, RecordUploadCDNMgrDelegate>
{
