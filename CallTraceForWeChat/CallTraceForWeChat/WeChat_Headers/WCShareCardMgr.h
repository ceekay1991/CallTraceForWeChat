...
@interface WCShareCardMgr : MMService <MMServiceProtocol, WCShareCardSyncMgrDelegate, WCShareCardBatchGetMgrDelegate, PBMessageObserverDelegate, LocationRetrieveDelegate, MMKernelExt>
{
