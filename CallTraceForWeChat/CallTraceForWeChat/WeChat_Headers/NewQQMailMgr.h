...
@interface NewQQMailMgr : MMService <INewSyncExt, MMServiceProtocol, INewQQMailExt, UploadConversationFileDelegate, ComposeSendDelegate, UploadAttachmentDataDelegate>
{
