...
@interface PSTNMgr : MMService <AUAudioDataSource, IAUAudioDeviceExt, PBMessageObserverDelegate, ISysCallCheckExt, IPSTNSyncExt, INetworkStatusMgrExt, MMServiceProtocol>
{
    int mStatus;
