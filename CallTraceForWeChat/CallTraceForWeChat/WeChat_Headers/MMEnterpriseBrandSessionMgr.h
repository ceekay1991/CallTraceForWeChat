...
@interface MMEnterpriseBrandSessionMgr : MMService <ISessionInfoExt, MMServiceProtocol, IMsgExt, IContactMgrExt, IMMNewSessionMgrExt, IMMNewSessionMgrFilterExt, IEnterpriseBrandContactMgrExt>
{
