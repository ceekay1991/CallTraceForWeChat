...
@class CMMotionManager, MMTimer, MMUIActivityIndicatorView, NSMutableArray, NSString, UIButton, UIImageView, WCPayFaceHBFaceView, WCPayFaceHBQRCodeInfo, WCPayFaceHBQRCodeView, WCPayFaceReceiverView, WCPayFaceRedEnvelopesReceiverInfo, WCPayGoldenStatusView;
