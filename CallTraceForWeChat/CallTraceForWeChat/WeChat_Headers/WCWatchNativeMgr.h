...
@interface WCWatchNativeMgr : MMService <WCSessionDelegate, PBMessageObserverDelegate, MMKernelExt, INetworkStatusMgrExt, ICdnComMgrExt, IContactMgrExt, IMsgExt, IDownloadImageExt, IVideoExt, IMMNewSessionMgrExt, MMServiceProtocol>
{
