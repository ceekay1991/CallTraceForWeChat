...
@interface StoreEmotionRecoverMgr : MMService <StoreEmotionRecoverLogicObjectDelegate, StoreEmotionDownloadLogicObjectDelegate, IMsgExt, StoreEmotionAddTaskDelegate, StoreEmotionDeleteTaskDelegate, StoreEmotionDeleteExt, CNetworkStatusExt, MMServiceProtocol>
{
    int _scene;
