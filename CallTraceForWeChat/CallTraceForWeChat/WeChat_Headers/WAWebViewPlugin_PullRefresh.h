...
@interface WAWebViewPlugin_PullRefresh : WAWebViewPluginBase <EGORefreshTableHeaderDelegate>
{
    ...
    _Bool _bShowingRefreshBeforeRotate;
}

@property(nonatomic) _Bool bShowingRefreshBeforeRotate; // @synthesize bShowingRefreshBeforeRotate=_bShowingRefreshBeforeRotate;
