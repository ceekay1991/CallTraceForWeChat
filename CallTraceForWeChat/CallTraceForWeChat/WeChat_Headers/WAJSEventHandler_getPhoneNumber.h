...
@interface WAJSEventHandler_getPhoneNumber : WAJSEventHandler_BaseEvent <WAWebViewPlugin_ApiQueueProtocol, WAPhoneConfirmWindowDelegate, WAPhoneVerifyWindowDelegate, WCAccountBindPhoneControlLogicDelegate, MMUIViewControllerDelegate, MMTipsViewControllerDelegate>
{
    _Bool _needVerify;
    ScopeInfo *_scope;
