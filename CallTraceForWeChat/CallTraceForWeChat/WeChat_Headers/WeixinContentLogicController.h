...
@interface WeixinContentLogicController : BaseMsgContentLogicController <IQQMailExt, VerifyQQPwdMgrExt, OpenIMSucceedContactLogicLogicDelegate, addContactToChatRoomDelegate, TipsViewDelegate, ITranslateMsgMgrExt>
{
    _Bool m_bTipsShow;
